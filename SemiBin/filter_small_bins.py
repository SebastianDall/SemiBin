...
def filter_small_bins(logger, fastafile: str, resultfile: str, args, minbinsize: int = 200000) -> None:
    ...
    gen_bins(fastafile, outputdir, os.path.join(os.path.dirname(outputdir), '../comebin_bins', 'comebin_res_bins'))
    shutil.copy2(outputdir, os.path.join(os.path.dirname(outputdir), '../comebin_bins', 'comebin_res.tsv'))